---
title: "Meldeverzug hebelt "Notbremse" aus
...
Defined as
![](https://github.com/nashtash/learn_ml/blob/master/assets/images/Unbenannt.png?raw=true=150x)
...
**WoW** you made it all the way down here, Congrats! In the next post, we'll start to push some code! So get R ready to take off :bar_chart:
